...
class MimeTypesTest {
  ...
  void kickAllTest(){
    test('testGetMediaMimeType_fromValidCodecs_returnsCorrectMimeType', () async {
    ...
    test('testGetMimeTypeFromMp4ObjectType_forValidObjectType_returnsCorrectMimeType', () async {
    ...
    test('testGetMimeTypeFromMp4ObjectType_forInvalidObjectType_returnsNull', () async {
